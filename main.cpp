...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow((int)(1280 * main_scale), (int)(800 * main_scale), "SolarManager", nullptr, nullptr);
    ...
    if (font == nullptr) {
        MessageBoxA(NULL, "无法加载 c:\\Windows\\Fonts\\msyh.ttc", "错误", MB_OK | MB_ICONERROR);
    }
